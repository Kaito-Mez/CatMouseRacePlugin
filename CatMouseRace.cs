...
public class CatMouseRace
{
    ...
    public delegate CatMouseRace Factory(EntryCar challenger, EntryCar challenged, bool lineUpRequired = true);
    
    public CatMouseRace(EntryCar challenger, EntryCar challenged, SessionManager sessionManager, EntryCarManager entryCarManager, CatMouseChallengePlugin plugin, bool lineUpRequired = true)
    {
